...
namespace HRManagement.Application.Features.LeaveAllocation.Commands.CreateLeaveAllocation
{
    public class CreateLeaveAllocationCommandHandler : IRequestHandler<CreateLeaveAllocationCommand, Unit>
    {
        ...
        public async Task<Unit> Handle(CreateLeaveAllocationCommand request, CancellationToken cancellationToken)
        {
            ...
            //Assign Allocations
            var allocations = new List<HRmanagementDomain.LeaveAllocation>();
            foreach (var emp in employees)
            {
                ...
                {
                    allocations.Add(new HRmanagementDomain.LeaveAllocation
                    {
                        EmployeeId = emp.Id,
            ...
            //var leaveAllocation = _mapper.Map<HRmanagementDomain.LeaveAllocation>(request);
